...
const configs_1 = __webpack_require__(3);
const findTest_1 = __webpack_require__(4);
const jest_1 = __webpack_require__(5);
const jestConfig_1 = __webpack_require__(8);
...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        subscriptions.push(coc_nvim_1.commands.registerCommand("jest.fileTest", runFile));
...
function initJest() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        coc_nvim_1.window.runTerminalCommand("jest --init", root);
    });
}
function runProject() {
    return __awaiter(this, void 0, void 0, function* () {
...
function getReltivePath() {
    return __awaiter(this, void 0, void 0, function* () {
        const currentFilePath = yield coc_nvim_1.workspace.nvim.eval('expand("%:p")');
        return path_1.default.relative(coc_nvim_1.workspace.cwd, currentFilePath);
    });
}
function runFile() {
    return __awaiter(this, void 0, void 0, function* () {
        const watchCmd = yield configs_1.isWatchCmd();
        const currentFilePath = yield getReltivePath();
...
function runJestCommand(cmd = "") {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const jestBinCmd = (yield configs_1.getJestBinCmd()) || (yield jest_1.makeJestBinCmd());
 ...
 */
const nodeBinExtension = os_1.platform() === 'win32' ? '.cmd' : '';
/**
...
const getLocalPathForExecutable = (rootPath, executable) => {
    const absolutePath = path_1.normalize(path_1.join(rootPath, 'node_modules', '.bin', executable + nodeBinExtension));
    return fs_1.existsSync(absolutePath) ? absolutePath : undefined;
};
/**
...
const findJestConfigPath = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const configPath = yield common_1.findUp(configFileName, cwd);
    if (configPath === "") {
        return "";
    }
...
const path_1 = __importDefault(__webpack_require__(2));
const util_1 = __importDefault(__webpack_require__(10));
